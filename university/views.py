...
class StudyFieldsList(generics.ListAPIView):
	serializer_class = StudyFieldsListSerializer
	queryset = StudyField.objects.all()


class StudyFieldInfo(generics.RetrieveAPIView):
	serializer_class = StudyFieldInfoSerializer
	queryset = StudyField.objects.all()
	lookup_field = 'id'